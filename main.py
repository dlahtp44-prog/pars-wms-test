...
from app.pages.legacy_redirects import router as legacy_redirects_router
...
from app.routers.api_memos import router as api_memos_router


app = FastAPI(title="PARS WMS", version="1.8.1")
...
app.include_router(api_memos_router)
